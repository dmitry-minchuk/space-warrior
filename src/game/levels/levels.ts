...
export const LEVELS: LevelData[] = [
  // ===== 1: Earth, intro =====
  {
    ...
    waves: [
      ...
      w(26, 'scout', 8, 'random'),
      w(38, 'scout-shooter', 6, 'line'),
      w(50, 'fighter', 3, 'v'),
      w(62, 'scout', 8, 'arc'),
      w(74, 'fighter', 4, 'line'),
      w(86, 'scout-shooter', 6, 'random'),
    ],
  },
  // ===== 2: Earth orbit =====
  {
  ...
  // ===== 4: Lunar base =====
  {
    ...
    waves: [
      ...
      w(34, 'bomber', 2, 'v'),
      w(46, 'interceptor', 4, 'arc'),
      w(58, 'fighter', 6, 'arc'),
      w(70, 'interceptor', 4, 'v'),
      w(82, 'bomber', 3, 'line'),
      w(94, 'scout-shooter', 8, 'random'),
      w(106, 'interceptor', 5, 'arc'),
      w(118, 'fighter', 5, 'v'),
    ],
  },
  // ===== 5: Belt outskirts — drones =====
  {
    ...
    waves: [
      w(3, 'fighter', 4, 'arc'),
      w(12, 'drone', 10, 'swarm'),
      w(24, 'interceptor', 3, 'v'),
      w(34, 'drone', 12, 'swarm'),
      w(46, 'drone-shooter', 6, 'arc'),
      w(58, 'fighter', 6, 'line'),
      w(70, 'drone', 14, 'swarm'),
      w(82, 'bomber', 2),
      w(92, 'interceptor', 5, 'arc'),
      w(104, 'drone-shooter', 8, 'swarm'),
  ...
  // ===== 6: Abandoned station — turrets =====
  {
    ...
    waves: [
      w(3, 'fighter', 4, 'arc'),
      w(12, 'turret', 2, 'line'),
      w(24, 'interceptor', 4, 'v'),
      w(34, 'turret', 2),
      w(46, 'fighter', 6, 'arc'),
      w(56, 'turret', 3, 'line'),
      w(70, 'bomber', 2),
      w(82, 'interceptor', 4, 'arc'),
      w(92, 'turret', 2),
      w(104, 'fighter', 6, 'v'),
      w(116, 'turret', 3, 'line'),
    ],
  ...
  // ===== 15: Hive — drone swarms + elites =====
  {
    ...
    waves: [
      ...
      w(24, 'drone', 16, 'swarm'),
      w(36, 'drone-shooter', 10, 'arc'),
      w(48, 'elite-interceptor', 5),
      w(60, 'drone', 18, 'swarm'),
      w(72, 'tesla', 4),
      w(84, 'elite-interceptor', 6, 'arc'),
      w(96, 'drone-shooter', 12, 'arc'),
      w(110, 'elite-fighter', 6, 'arc'),
      w(122, 'drone', 20, 'swarm'),
